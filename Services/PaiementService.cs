...
// reste a payer - pour que l'ecran donne un retour clair (pas juste
// "ca a marche" ou "ca n'a pas marche").
...
public class PaiementService
{
    ...
    // pour deduire le solde restant au moment de la facture finale, et
    // pour valider un nouvel acompte par rapport au tarif).
    ...
    // (rendez-vous deja regle en totalite avant meme la consultation).
